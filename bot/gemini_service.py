...
TOOLS = [
    {
        "function_declarations": [
                    ...
                    "properties": {
                        ...
                        "carrier": {
                            ...
                            "description": (
                                ...
                                "DPD, Boxberry, Magic Trans. Пустая строка, если не названа."
                            ),
                        },
                    },
            ...
            },
            {
                ...
                "description": (
                    "Записать трек-номер последней мили (СДЭК, Яндекс, Почта России, "
                    "Magic Trans и т.д.) для существующего заказа. Используй, когда "
                    "пользователь пишет «трек A1042 СДЭК 1234567890», "
                    "«A1042 отправил Magic Trans 008654745», "
                    ...
                    "properties": {
                        ...
                        "carrier": {
                            ...
                            "description": (
                                ...
                                "Magic Trans. Пустая строка, если пользователь её не назвал."
                            ),
                        },
                    },
